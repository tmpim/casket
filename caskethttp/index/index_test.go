...
func TestIndexIncompleteParams(t *testing.T) {
	c := casket.NewTestController("", "index")
...
func TestIndex(t *testing.T) {
	c := casket.NewTestController("http", "index a.html b.html c.html")
...
func TestMultiSiteIndexWithEitherHasDefault(t *testing.T) {
	...
	customIndex := casket.NewTestController("http", "index a.html b.html")
	...
	defaultIndex := casket.NewTestController("http", "")
...
func TestPerSiteIndexPageIsolation(t *testing.T) {
	...
	firstSite := casket.NewTestController("http", "index first.html")
	err := setupIndex(firstSite)
	if err != nil {
		t.Errorf("Expected no errors, got: %v", err)
	}

	secondSite := casket.NewTestController("http", "index second.html")
