...
func init() {
	casket.RegisterPlugin(pluginName, casket.Plugin{
...
func setupLimits(c *casket.Controller) error {
...
func parseLimits(c *casket.Controller) ([]httpserver.PathLimit, error) {
