...
func NewStaticUpstreams(c casketfile.Dispenser, host string) ([]Upstream, error) {
...
func parseBlock(c *casketfile.Dispenser, u *staticUpstream, hasSrv bool) error {
	var isUpstream bool
	...
	for _, host := range u.Hosts {
		...
		for _, addr := range candidates {
			...
			unhealthy := func() bool {
				...
				//      See https://github.com/tmpim/casket/pull/1691
