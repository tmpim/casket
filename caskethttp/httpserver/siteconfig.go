...
type SiteConfig struct {
	...
	// source Casketfile). TODO: Enforcing this
	...
	// The path to the Casketfile used to generate this site config
	originCasketfile string
...
func (s SiteConfig) TLSConfig() *caskettls.Config {
	return s.TLS
}
