...
type (
	...
	ListenerMiddleware func(casket.Listener) casket.Listener
...
func IndexFile(root http.FileSystem, fpath string, indexFiles []string) (string, bool) {
	if len(fpath) == 0 {
		// https://casket.community/t/panic-runtime-error-index-out-of-range/5781
		fpath = "/"
	}
