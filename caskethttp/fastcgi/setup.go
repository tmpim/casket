...
func init() {
	casket.RegisterPlugin("fastcgi", casket.Plugin{
		ServerType: "http",
		Action:     setup,
	})
}
...
func setup(c *casket.Controller) error {
	...
	cfg.AddMiddleware(func(next httpserver.Handler) httpserver.Handler {
		return Handler{
			...
			SoftwareName:    casket.AppName,
			SoftwareVersion: casket.AppVersion,
...
func fastcgiParse(c *casket.Controller) ([]Rule, error) {
	var rules []Rule
