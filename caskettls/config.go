...
// buildStandardTLSConfig converts cfg (*caskettls.Config) to a *tls.Config
...
// tls.Config is programmed to load the matching caskettls.Config
...
func MakeTLSConfig(configs []*Config) (*tls.Config, error) {
	...
	for i, cfg := range configs {
		...
		// convert this caskettls.Config into a tls.Config
	...
	return &tls.Config{
		...
		// only GetConfigForClient set. https://github.com/tmpim/casket/pull/2404
...
type ConfigGetter func(c *casket.Controller) *Config
...
// If updating this map, also update tlsProtocolStringToMap in caskethttp/fastcgi/fastcgi.go
...
//
// See https://github.com/tmpim/casket/issues/1674
...
// accessing the certificate storage on the *casket.Instance.
